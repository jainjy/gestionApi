...
router.get("/all", async (req, res) => {
  try {
    ...
    // 🔧 CORRECTION: Définir le tri par défaut
  ...
  async (req, res) => {
    try {
      ...
      res.json({
        success: true,
        data: product,
        message: "Produit créé et notification envoyée",
      });
    } catch (error) {
...
router.delete(
  ...
  async (req, res) => {
    try {
      ...
      res.json({
        success: true,
        message: "Produit supprimé avec succès et notification envoyée",
      });
    } catch (error) {
